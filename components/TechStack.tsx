      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-6">
        {skills.map((skill, i) => (
          <motion.div
            ...
            className="flex flex-col items-center justify-center p-6 bg-[#0d1117] border border-[#30363d] rounded-xl transition-all duration-300 group cursor-default select-none hover:border-[#39d353]"
          >
            <div className="mb-3 flex items-center justify-center w-14 h-14 bg-black rounded-lg border border-[#30363d]/50 group-hover:border-[#39d353]/30 transition-colors">
              {skill.slug === "rag" ? (
                <svg viewBox="0 0 24 24" className="w-8 h-8 fill-none stroke-[#39d353] transition-transform group-hover:scale-110 duration-300 select-none pointer-events-none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <circle cx="12" cy="14" r="2.5" fill="#000000" />
